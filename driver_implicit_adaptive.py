...
plt.xlabel('$t$')
plt.ylabel('$y$')
plt.title('Oregonator Solution (DIRK21, %i steps)' % (AD21.get_num_steps()))
...
plt.xlabel('$t$')
plt.ylabel('$y$')
plt.title('Oregonator Solution (DIRK32, %i steps)' % (AD32.get_num_steps()))
...
plt.xlabel('$t$')
plt.ylabel('$y$')
plt.title('Oregonator Solution (DIRK43, %i steps)' % (AD43.get_num_steps()))
...
plt.xlabel('$t$')
plt.ylabel('$y$')
plt.title('Oregonator Solution (DIRK54, %i steps)' % (AD54.get_num_steps()))
...
plt.xlabel('$t$')
plt.ylabel('$h$')
plt.title('Oregonator -- adaptive step history')
plt.legend()
